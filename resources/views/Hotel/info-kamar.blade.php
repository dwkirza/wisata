...
<body>
    ...
    <div class="container">
        ...
        <section class=" text-center container">
            <div class="container">
                <div class="row">
                    <h1 class="fw-light" style="font-size: 45; font-family: 'Mulish', sans-serif;">{{ $hotel['name'] }}
                    </h1>
                    <br><br><br><br>
                    <div class="col-sm-6"><img src="/assets/img/zurichhotel5.jpg" class="d-block w-100" alt="...">
                    </div>
            ...
            <div class=" container" style="text-align: left;">
                <div class="row">
                    <div class="col-sm-5 col-md-6">
                        ...
                        <p class="card-text" style="text-align: justify;">Selain standar dari Indonesia Care, semua tamu
                            akan mendapatkan Wi-Fi gratis di semua kamar dan parkir gratis jika tiba dengan mobil.
                            Terletak strategis di Pusat Kota Balikpapan yang merupakan bagian Balikpapan, properti ini
                            menempatkan Anda dekat dengan atraksi dan opsi restoran menarik. Jangan pulang dulu sebelum
                            berkunjung ke Balikpapan Plaza yang terkenal. Memiliki peringkat bintang-3, properti
